...
export const SwitchTheme = ({ className }: { className?: string }) => {
  ...
  return (
    <div className={`flex flex-col items-center justify-center gap-2 ${className}`}>
      <div className="flex items-center gap-2 bg-gradient-to-r from-purple-100 to-blue-100 dark:from-purple-900 dark:to-blue-900 p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300">
        <input
          id="theme-toggle"
          type="checkbox"
          ...
          checked={isDarkMode}
        />
        <label htmlFor="theme-toggle" className={`swap swap-rotate cursor-pointer ${!isDarkMode ? "swap-active" : ""}`}>
      ...
      <span className="text-xs font-medium text-purple-600 dark:text-purple-300">Theme</span>
    </div>
  );
};
